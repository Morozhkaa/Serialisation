/* package models contains generated code using protoc (taken from models/proto/gen),
   and functions for creating a new student instance, serialization and deserialization */
...
func NewStudent(s *Student) {
	...
	s.Percentile = 50.78
	s.Direction = 2
	s.Courses = []string{"machine learning", "database", "design of fault-tolerant systems",
		"service-oriented architectures", "optimization methods"}
	s.Marks = map[string]int32{"machine learning": 5, "database": 7, "design of fault-tolerant systems": 8,
		"service-oriented architectures": 8, "optimization methods": 6}
}

func SerializeProto(s *Student) ([]byte, error) {
	return proto.Marshal(s)
}

func DeserializeProto(data []byte, s *Student) error {
